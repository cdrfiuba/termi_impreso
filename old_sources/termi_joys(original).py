...
lecturas=[0,0,0,0,0,0]						#Vector con lecturas de los conversores AD
...
def leer_serie(lecturas):	#Funcion que lee conversiones AD que envia el micro por serie
    for i in lecturas:
	lecturas[i]=ardruino.read()
